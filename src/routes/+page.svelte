    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        {#each stats as stat}
            <a href={stat.href} class="block group">
                <Card className="p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 active:scale-95 border-2 border-transparent hover:border-indigo-100">
                    ...
                    <div class="mt-8 flex items-center justify-between text-indigo-600 font-bold">
