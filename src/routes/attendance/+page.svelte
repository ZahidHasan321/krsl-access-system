...
<div class="print-only hidden">
    <div class="print-header" style="display: flex !important; justify-content: space-between; align-items: center; padding: 1rem 0; border-bottom: 2px solid #333; margin-bottom: 1rem;">
        <div style="display: flex; align-items: center; gap: 12px;">
            ...
            <div>
                ...
                <p style="font-size: 12px; color: #666; margin: 4px 0 0 0;">Current Entry Log Report</p>
            </div>
        </div>
        <div style="text-align: right;">
            <p style="font-size: 14px; font-weight: 600; margin: 0;">{format(new Date(), 'PPPP')}</p>
            <p style="font-size: 12px; color: #666; margin: 4px 0 0 0;">Printed at {format(new Date(), 'hh:mm a')}</p>
        </div>
    </div>
    ...
    <div style="margin-bottom: 1rem; padding: 0.75rem; background: #f5f5f5; border-radius: 4px;">
        <p style="font-size: 14px; font-weight: 600; margin: 0;">
            Total People Currently Inside: <strong>{filteredLogs.length}</strong>
        </p>
    ...
    <table style="width: 100%; border-collapse: collapse; font-size: 12px;">
        ...
        <tbody>
            ...
            {:else}
                <tr>
                    <td colspan="7" style="border: 1px solid #ddd; padding: 20px; text-align: center; color: #666;">
                        No one currently on premises
                    </td>
                </tr>
            {/each}
        </tbody>
    ...
    <div style="margin-top: 2rem; padding-top: 1rem; border-top: 1px solid #ddd; display: flex; justify-content: space-between; font-size: 10px; color: #666;">
...
<div class="no-print">
    <div class="space-y-6 pb-24">
        <div class="flex flex-col xl:flex-row justify-between items-stretch xl:items-center gap-4">
            <div class="flex items-center gap-4">
                ...
                <Badge class="bg-primary-100 text-primary-700 border-primary-200 font-bold text-sm">
            ...
            <div class="flex flex-col md:flex-row items-stretch md:items-center gap-3 flex-1 xl:max-w-3xl">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <Button
                        variant="outline"
                        class="h-14 px-6 rounded-2xl font-bold gap-2 border-2 border-slate-200 hover:border-primary-300 hover:bg-primary-50 transition-all"
    ...
    {#if data.user?.permissions.includes('people.create')}
        <div class="fixed bottom-8 right-8 flex flex-col gap-3 z-30">
            ...
            <Button
                variant="default"
                class="h-16 px-8 rounded-2xl shadow-2xl font-black text-lg gap-3 animate-in slide-in-from-bottom-12 duration-500 hover:scale-105 active:scale-95 transition-all"
