...
<svelte:head>
    <title>Portal - {data.labour.name} | {i18n.t('appName')}</title>
</svelte:head>

<div class="space-y-8">
    <!-- Header Card -->
    <Card className="p-6 md:p-8 border-amber-100 shadow-amber-50">
                    ...
                    <div>
                        <div class="flex items-center gap-3">
                            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight font-header leading-tight py-1">
                                {data.labour.name} <span class="text-primary-600">/</span> {i18n.t('portal')}
                            </h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="p-6 border-amber-50">
    ...
    <!-- History Section -->
    <div class="space-y-4">
        <h2 class="text-xl font-black text-gray-900 px-1">{i18n.t('history')} (Portal)</h2>
